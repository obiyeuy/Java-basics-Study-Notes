...
public class C3P0_ {
        ...
        public void testC3P0_02() throws SQLException {
            ComboPooledDataSource comboPooledDataSource = new ComboPooledDataSource("yueyibo_c3p0");
            //测试 5000 次连接 mysql
            long start = System.currentTimeMillis();
            ...
            long end = System.currentTimeMillis();
            //c3p0 的第二种方式 耗时=2343
            System.out.println("c3p0 的第二种方式(5000) 耗时=" + (end - start));
        }
}
