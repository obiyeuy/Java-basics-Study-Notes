...
class CustomGeneric_ {
    public static void main(String[] args) {
        //T=Double, R=String, M=Integer
        Bird<Double,String,Integer> g = new Bird<>("john");
        g.setT(10.9); //OK
        //g.setT("yy"); //错误，类型不对
        System.out.println(g);
        Bird g2 = new Bird("john~~");//OK T=Object R=Object M=Object
...
class Bird<T, R, M> {
    ...
    public Bird(R r, M m, T t) {//构造器使用泛型
        this.r = r;
        this.m = m;
        this.t = t;
    }
    public Bird(String name, R r, M m, T t) {//构造器使用泛型
        this.name = name;
        this.r = r;
        this.m = m;
        this.t = t;
