package com.yueyibo.self_study.internet.udp;
...
public class UDPSenderB {
    public static void main(String[] args) throws IOException {
        ...
        DatagramPacket packet = new DatagramPacket(data, data.length, InetAddress.getByName("192.168.235.1"), 9999);
        socket.send(packet);

        //3.=== 接收从 A 端回复的信息
        //(1) 构建一个 DatagramPacket 对象，准备接收数据
        // 在前面讲解 UDP 协议时，说过一个数据包最大 64k
