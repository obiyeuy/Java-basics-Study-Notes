...
public class ReflectionUtils {
    ...
    public void api_02() throws ClassNotFoundException, NoSuchMethodException {
        //得到 Class 对象
        Class<?> personCls = Class.forName("com.yueyibo.reflection.Person");
        ...
        for (Constructor<?> declaredConstructor : declaredConstructors) {
            System.out.println("====================");
            System.out.println("本类中所有构造器=" + declaredConstructor.getName());//这里老师只是输出名字
    ...
    public void api_01() throws ClassNotFoundException, NoSuchMethodException {
        ...
        //getDeclaredFields:获取本类中所有属性(非public修饰的都能拿到)
        Field[] declaredFields = personCls.getDeclaredFields();
        for (Field declaredField : declaredFields) {
            System.out.println("本类中所有属性=" + declaredField.getName());
        }
        ...
        //getDeclaredMethods:获取本类中所有方法(非public修饰的都可以)
        Method[] declaredMethods = personCls.getDeclaredMethods();
        for (Method declaredMethod : declaredMethods) {
            System.out.println("本类中所有方法=" + declaredMethod.getName());
        }
        ...
        //getDeclaredConstructors:获取本类中所有构造器(非public修饰的都可以)
        Constructor<?>[] declaredConstructors = personCls.getDeclaredConstructors();
        for (Constructor<?> declaredConstructor : declaredConstructors) {
        ...
        System.out.println(personCls.getPackage());//com.yueyibo.reflection
